...
## 2. SITL 설치 (mac에서는 다른 방법을 사용해야 할듯)

    // 필수 패키지 설치
    % brew tap PX4/px4
    % brew install px4-dev 
    % brew install coreutils gawk libtool libffi wget
    % pip install empy pexpect future
    ...
    // 실행
    % ./Tools/autotest/sim_vehicle.py --console --map -v ArduCopter
